...
import OrganizeU from "../assets/organizeUSamplepic.png";
    ...
    <>
      ...
      {currentStep === 1 && (
        <div className="h-screen flex flex-col mt-7 mx-24 items-center">
          <div className="text-blue-700 font-body text-center mb-2">
            ...
            <p className="text-lg mb-8 text-blue-500">
              ...
              productivity. Seamlessly manage projects, assign tasks, and track
              progress with your team. Say goodbye to scattered to-do lists and
              hello to organized, efficient collaboration. Let's start achieving
              more together!
            </p>
            <button
